    ...
    function () {
      ...
      _proto.hide = function hide() {
        ...
        if (triggerArrayLength > 0) {
          for (let i = 0; i < triggerArrayLength; i++) {
            ...
            if (selector !== null) {
              let $elem = $$$1([].slice.call(document.querySelectorAll(selector)));
      ...
      Collapse._jQueryInterface = function _jQueryInterface(config) {
        return this.each(function () {
          ...
          let _config = _objectSpread({}, Default, $this.data(), typeof config === 'object' && config ? config : {});
  ...
  let Dropdown = function ($$$1) {
    ...
    function () {
      ...
      _proto._getPlacement = function _getPlacement() {
        let $parentDropdown = $$$1(this._element.parentNode);
      ...
      Dropdown._dataApiKeydownHandler = function _dataApiKeydownHandler(event) {
        ...
        let items = [].slice.call(parent.querySelectorAll(Selector.VISIBLE_ITEMS));
    ...
    function () {
      ...
      _proto.show = function show() {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          let container = this.config.container === false ? document.body : $$$1(document).find(this.config.container);
  ...
  let ScrollSpy = function ($$$1) {
    ...
    function () {
      ...
      _proto._activate = function _activate(target) {
        ...
        let $link = $$$1([].slice.call(document.querySelectorAll(queries.join(','))));
      ...
      _proto._clear = function _clear() {
        let nodes = [].slice.call(document.querySelectorAll(this._selector));
